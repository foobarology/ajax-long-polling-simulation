<template>
  <div class="stage">
    <h1 class="title">AJAX Long Polling Simulation</h1>
...
export default {
  ...
  methods: {
    ...
    async appResponseToClient1 (messages) {
      this.client1HttpText = 'http response';
      await this.$refs.client1HttpBullet.move({x: 370, y: 225}, {x: 110, y: 225}, {
        duration: 750,
        message: 'http request',
        messagePosition: 'top',
        color: '21A9BE',
      ...
      this.client1HttpText = '';
      this.$refs.client1HttpBullet.hide();
